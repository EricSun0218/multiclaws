...
export type OpenClawPluginApi = {
    ...
    runtime?: {
        channel: {
            telegram: {
                sendMessageTelegram: (to: string, text: string, opts?: {
                    accountId?: string;
                    messageThreadId?: number;
                }) => Promise<unknown>;
            };
            whatsapp: {
                sendMessageWhatsApp: (to: string, text: string, opts: {
                    verbose: boolean;
                    accountId?: string;
                }) => Promise<unknown>;
            };
            ...
            imessage: {
                sendMessageIMessage: (to: string, text: string, opts?: {
                    accountId?: string;
                }) => Promise<unknown>;
            };
            line: {
                sendMessageLine: (to: string, text: string, opts?: {
                    accountId?: string;
                    verbose?: boolean;
                }) => Promise<unknown>;
            };
            slack: {
                sendMessageSlack: (to: string, text: string, opts?: {
                    accountId?: string;
                    threadTs?: string;
                }) => Promise<unknown>;
            };
            discord: {
                sendMessageDiscord: (to: string, text: string, opts?: {
                    accountId?: string;
                }) => Promise<unknown>;
            };
        };
